...
export default async function Admin() {
  ...
  const [{ data: projects }, { data: products }, { data: updates }, { data: homepage }, { data: settings }] = await Promise.all([
